...
class RespData {
  ...
  RespData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['delivery_boy_details'] != null) {
      deliveryBoyDetails = <DeliveryBoyDetails>[];
      json['delivery_boy_details'].forEach((v) {
        deliveryBoyDetails.add(new DeliveryBoyDetails.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.deliveryBoyDetails != null) {
      data['delivery_boy_details'] =
          this.deliveryBoyDetails.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
